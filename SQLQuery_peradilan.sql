...
CREATE TABLE PERKARA (
    ...
    CONSTRAINT [FK_PR_SI] FOREIGN KEY ([No_Sidang]) REFERENCES [SIDANG] ([No_Sidang]),
    ...
    CONSTRAINT [FK_PR_NS] FOREIGN KEY ([No_Surat]) REFERENCES [RIWAYAT] ([No_Surat])
);
...
-- TERDAKWA, PENGGUGAT, TERGUGAT, TURUT_TERGUGAT
...
CREATE TABLE TURUT_TERGUGAT (
    Id_SubjekHukum NVARCHAR(128),

    CONSTRAINT [PK_TTG] PRIMARY KEY ([Id_SubjekHukum]),
    CONSTRAINT [FK_TTG] FOREIGN KEY ([Id_SubjekHukum]) REFERENCES [SUBJEK_HUKUM] ([Id_SubjekHukum])
);
...
CREATE TABLE DIGUGAT (
    Id_SubjekHukum_Tergugat NVARCHAR(128),
        No_Perkara NVARCHAR(128),
    Id_SubjekHukum_Turut_Tergugat NVARCHAR(128) NULL,
    ...
    CONSTRAINT [FK_DG_IDSTT] FOREIGN KEY ([Id_SubjekHukum_Turut_Tergugat]) REFERENCES [TURUT_TERGUGAT] ([Id_SubjekHukum])
);
